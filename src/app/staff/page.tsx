          ...
          >
            <span className="inline-flex items-center gap-2">
              ...
              <span className="inline-flex items-center gap-1 text-xs">
                <span className="px-2 py-0.5 rounded-full bg-red-100 text-red-800 border border-red-200">C: {urgentAlerts.filter(a => a.priority === 1).length}</span>
                <span className="px-2 py-0.5 rounded-full bg-orange-100 text-orange-800 border border-orange-200">H: {urgentAlerts.filter(a => a.priority === 2).length}</span>
              </span>
            </span>
          </button>
          <button
